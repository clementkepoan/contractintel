...
class Settings(BaseModel):
    ...
    local_model_name: str = os.getenv("LOCAL_MODEL_NAME", "lmstudio-community/Qwen3-4B-Instruct-2507-MLX-5bit")
    local_query_model_name: str = os.getenv("LOCAL_QUERY_MODEL_NAME", "Qwen3.5-9B-Claude-4.6-HighIQ-INSTRUCT-HERETIC-UNCENSORED-mlx-4Bit")
