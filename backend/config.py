...
class Settings(BaseModel):
    ...
    local_model_name: str = _env_str("LOCAL_MODEL_NAME", "Qwen3-4B-Instruct-2507-4bit")
    local_query_model_name: str = _env_str("LOCAL_QUERY_MODEL_NAME", "Ministral-3-8B-Instruct-2512-4bit")
